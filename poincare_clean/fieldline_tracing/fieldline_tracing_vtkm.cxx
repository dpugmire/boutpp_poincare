...
vtkm::FloatDefault scalarField1DInterpolate(const vtkm::cont::ArrayHandle<vtkm::FloatDefault>& x,
...
*/
    ...
    for (const auto& iline : LINES)
    {
        ...
        auto zind2 = scalarField1DInterpolate(opts.ZiArray, opts.ZArray, {zStart});
