...
Spline::Spline(const std::vector<viskores::Vec3f>& pts)
  : Points(pts)
{
  auto n = pts.size();
...
void Spline::ComputeSplineCoefficients()
{
...
viskores::Vec3f Spline::Evaluate(viskores::FloatDefault t) const
{
...
size_t Spline::FindInterval(viskores::FloatDefault val) const
{
